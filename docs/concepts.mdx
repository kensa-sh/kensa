...
| `kensa_trace.cost_usd` | Complete trace cost, or `None` when any billable span is unpriced |
| `kensa_trace.known_cost_usd` | Sum of priced spans, including when complete cost is unavailable |
