...
<Check>Prefer the guided path? [Quickstart](/quickstart) installs Kensa, finds and approves the production function or class used to start a conversation, and lands your first eval.</Check>
