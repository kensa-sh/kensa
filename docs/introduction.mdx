...
Generated from traces or written from scratch, your evals live in your repo as executable pytest or Vitest files. Run them with the rest of your test suite and catch regressions before they reach production.
...
This is a normal pytest test that any CI already running your Python suite can run. TypeScript projects use the same core semantics through the [TypeScript SDK](/typescript) and Vitest.
...
<Columns cols={2}>
  ...
  <Card title="Choose another journey" href="/journeys" cta="Compare journeys" arrow="true">
    Start from local evidence, Python, TypeScript, CI, or a connected trace source.
  </Card>
...
| Choose between local, Python, TypeScript, CI, or connected paths | [Choose a journey](/journeys) |
