...
pass/fail verdict with reasoning. When given `RunResult`, the judge receives ordered
...
|---|---|
| `output` | Evidence to evaluate, normally the `RunResult` returned by `case.run(...)` |
